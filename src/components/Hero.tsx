  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-brand-light-green/30 to-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-dark-green mb-6 leading-tight font-inter">
        ...
        <p className="text-xl sm:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto font-inter font-light animate-[fade-in-up_0.8s_ease-out] [animation-delay:1.4s] opacity-0 [animation-fill-mode:forwards]">
          Automate matching, AI-draft proposals, and track deadlines.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 animate-[scale-in_0.6s_ease-out] [animation-delay:1.8s] opacity-0 [animation-fill-mode:forwards] transform scale-95">
          <Button 
        ...
        <div className="text-sm text-gray-500 font-inter animate-[slide-up-fade_0.8s_ease-out] [animation-delay:2.2s] opacity-0 [animation-fill-mode:forwards] transform translate-y-2">
