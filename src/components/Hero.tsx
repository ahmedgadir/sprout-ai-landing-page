    ...
    <section className="min-h-screen bg-gradient-to-b from-brand-light-green/30 to-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center animate-fade-in">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-dark-green mb-6 leading-tight font-inter">
          Find More Grants.<br />
          Write Them Faster.<br />
          <span className="text-brand-primary-green">Do Work You Love.</span>
        </h1>
        
        <p className="text-xl sm:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto font-inter font-light">
