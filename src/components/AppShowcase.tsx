...
import { ArrowRight, BarChart3, Search, PenTool, Play, Pause, Star, Zap, Target, Clock } from 'lucide-react';

const AppShowcase = () => {
  const [activeStep, setActiveStep] = useState(0);
  const [isAutoPlay, setIsAutoPlay] = useState(true);

  // Reduced to 3 core features for better mobile experience
  const features = [
    {
      id: 1,
      ...
      <div className="relative py-12 sm:py-20 lg:py-32">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <div className="inline-flex items-center gap-2 bg-wise-forest-green/10 text-wise-forest-green px-3 py-2 rounded-full text-xs sm:text-sm font-medium mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              See how Fundsprout transforms your grant process with AI-powered matching and proposal writing.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg border border-gray-100 mb-12 sm:mb-16 lg:mb-20">
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[
                { icon: Search, value: "92%", label: "Match Accuracy" },
                ...
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-wise-forest-green/10 rounded-xl sm:rounded-2xl mb-3 sm:mb-4 group-hover:bg-wise-forest-green/20 transition-colors">
                    <stat.icon className="w-6 h-6 sm:w-8 sm:h-8 text-wise-forest-green" />
                  </div>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h4 className={`font-bold text-base sm:text-lg mb-2 ${isActive ? colors.text : 'text-gray-900'} leading-tight`}>
                      {feature.title}
                    </h4>
                      ...
                      <div className="relative aspect-[16/10] sm:aspect-[16/10]">
                        {features.map((feature, index) => (
                          ...
                          >
                            <img
                              src={feature.image}
                              alt={`${feature.title} interface showing grant writing platform`}
            ...
            <div className="bg-gradient-to-br from-wise-forest-green to-wise-bright-green rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 text-white">
              ...
              <div className="text-center">
                <a 
                  ...
                  className="inline-flex items-center justify-center bg-white text-wise-forest-green hover:bg-gray-100 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto"
                >
                  Schedule Your Demo
